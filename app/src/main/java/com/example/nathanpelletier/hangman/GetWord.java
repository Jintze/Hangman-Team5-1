...
/**
 * Created by Nathan Pelletier and Peter Zeng on 2017-12-04.
 */
...
public class GetWord {
  ...
  /* put in easy medium and hard because file wasn't loaded correctly on emulator */
  private String [] EASY = {"the", "of", "to", "and", "a", "in", "is", "it", "you", "that", "he",
      "was", "for", "on", "are", "with", "as", "I", "his", "they", "be", "at", "one", "have",
      "this", "from", "or", "had", "by", "hot", "word", "but", "what", "some", "we", "can", "out",
      "other", "were", "all", "there", "when", "up", "use", "your", "how", "said", "an", "each",
      "she", "which", "do", "their", "time", "if", "will", "way", "about", "many", "then", "them",
      "write", "would", "like", "so", "these", "her", "long", "make", "thing", "see", "him", "two",
      "has", "look", "more", "day", "could", "go", "come", "did", "number", "sound", "no", "most",
      ...
      "read", "hand", "port", "large", "spell", "add", "even", "land", "here", "must", "big",
  ...
  private String [] MEDIUM = {"ship", "area", "half", "rock", "order", "fire", "south", "problem",
  ...
  private String [] HARD = {"consonant", "nation", "dictionary", "milk", "speed", "method", "organ",
      "pay", "age", "section", "dress", "cloud", "surprise", "quiet", "stone", "tiny", "climb",
      "cool", "design", "poor", "lot", "experiment", "bottom", "key", "iron", "single", "stick",
      "flat", "twenty", "skin", "smile", "crease", "hole", "trade", "melody", "trip", "office",
      "receive", "row", "mouth", "exact", "symbol", "die", "least", "trouble", "shout", "except",
      "wrote", "seed", "tone", "join", "suggest", "clean", "break", "lady", "yard", "rise", "bad",
      "blow", "oil", "blood", "touch", "grew", "cent", "mix", "team", "wire", "cost", "lost",
      ...
      "insect", "caught", "period", "indicate", "radio", "spoke", "atom", "human", "history",
      "effect", "electric", "expect", "crop", "modern", "element", "hit", "student", "corner",
      "party", "supply", "bone", "rail", "imagine", "provide", "agree", "thus", "capital", "won't",
      ...
      "swim", "term", "opposite", "wife", "shoe", "shoulder", "spread", "arrange", "camp",
      "invent", "cotton", "born", "determine", "quart", "nine", "truck", "noise", "level",
      "chance", "gather", "shop", "stretch", "throw", "shine", "property", "column", "molecule",
      "select", "wrong", "gray", "repeat", "require", "broad", "prepare", "salt", "nose", "plural",
      "anger", "claim", "continent", "oxygen", "sugar", "death", "pretty", "skill", "women",
      "season", "solution", "magnet", "silver", "thank", "branch", "match", "suffix", "especially",
      ...
      "motion", "path", "liquid", "log", "meant", "quotient", "teeth", "shell"};



  /**
   * @param randomNumber an integer given from Random class
   * @param wordList a list with words of varying difficulty
   * @return String selected word.
   */
  private String selectWord(int randomNumber, String[] wordList) {
    String wordChosen = wordList[randomNumber];
    return wordChosen;
  }//selectWord
  ...
  /**
   *
   * @param difficulty name of difficulty selected
   * @return a list of the difficulty selected
   */
  private String[] changeDifficultyToStringList(String difficulty){
    if(difficulty == "easy"){
      return EASY;
    }//if easy
  ...
  }//changeDifficultyToStringList

  private String getWord(String difficulty) {
    final int randomNumber = getRandomNumber();
    String[] intDifficulty = changeDifficultyToStringList(difficulty);
    return selectWord(randomNumber, intDifficulty);
  }//getWord(String)

  /**
   * @param difficulty string given from button press
   */
  public String start(String difficulty) {
